...
500 times because each time you run add freindship it populates two friends, one for each of the connecting friends. 
...
2 60 nodes
Average users in an extended network 940
Average degree of seperation will be 4
